...
(async () => {
  ...
  await fs.writeFile("primary-malignancy_stomach-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("primary-malignancy_stomach-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
